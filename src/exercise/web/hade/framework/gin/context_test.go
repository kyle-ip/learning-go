...
import (
	...
	testdata "github.com/yipwinghong/hade/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/yipwinghong/hade/framework/gin.handlerNameTest$", c.HandlerName())
}
